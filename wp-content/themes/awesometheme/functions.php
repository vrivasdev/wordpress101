...
function awesome_script_enqueue() {
	...
	wp_enqueue_script('bootstrapjs', '', get_template_directory() . '/js/boostrap.min.js', array(), '3.3.4', true);
	wp_enqueue_script('customjs', '', get_template_directory() . '/js/awesome.js', array(), '1.0.0', true);
}
